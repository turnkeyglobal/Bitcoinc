...
// Copyright (c) 2009-2012 The Investcoin Core developers

it will change it to

// Copyright (c) 2009-2015 The Investcoin Core developers
'''
import os
import time
import re
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Investcoin/$1-%s The Investcoin/' %s"
REGEX_CURRENT= re.compile("%s The Investcoin" % year)
