...
/** Minmontcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MinmontcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MinmontcoinUnits(QObject *parent);

    /** Minmontcoin units.
      @note Source: https://en.minmontcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        INV,
...
typedef MinmontcoinUnits::Unit MinmontcoinUnit;
