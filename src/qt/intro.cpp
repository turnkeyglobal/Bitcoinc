...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/minmontcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Minmontcoin Core"),
     ...
     * override -datadir in the minmontcoin.conf file in the default data directory
     * (to be consistent with minmontcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
