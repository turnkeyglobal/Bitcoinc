...
#if defined(NDEBUG)
# error "Minmontcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Tokken Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s INV additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
   ...
   CAmount nSubsidy =0.01 * COIN; //0.01 * COIN; //16800000   Initial Amount GenesisReward
...
void ThreadScriptCheck() {
    RenameThread("minmontcoin-scriptch");
