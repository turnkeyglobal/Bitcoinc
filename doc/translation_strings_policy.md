...
This document provides guidelines for internationalization of the Minmontcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `minmontcoin_en.ts` remains unchanged.
