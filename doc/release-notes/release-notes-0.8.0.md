Minmontcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/minmontcoin/files/Minmontcoin/minmontcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Minmontcoin
...
New/changed settings (command-line or minmontcoin.conf file)
--------------------------------------------------------
