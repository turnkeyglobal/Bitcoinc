Minmontcoin Core version 0.9.4 is now available from:

  https://minmontcoin.org/bin/0.9.4/
...
this update is incompatible with the Minmontcoin system and could lead to consensus
forks.

Minmontcoin Core released binaries from https://minmontcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~minmontcoin/+archive/ubuntu/minmontcoin
- A third-party or self-compiled Minmontcoin Core

upgrade to Minmontcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
