Download URL: https://sourceforge.net/projects/minmontcoin/files/Minmontcoin/minmontcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 INV fee schedule (users still pay 0.01 INV per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #minmontcoin00 - #minmontcoin99
