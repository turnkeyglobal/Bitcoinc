Minmontcoin Core version 0.9.2.1 is now available from:

  https://minmontcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 INV to 0.01 INV
...
- Fix "Start minmontcoin on system login"
