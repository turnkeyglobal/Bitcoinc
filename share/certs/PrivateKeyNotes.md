...
unlocked to sign the Minmontcoin-Qt.app bundle.
...
allowing somebody to distribute a Minmontcoin-Qt.app or minmontcoin-qt-setup.exe with a valid
...
that the minmontcoin-qt.exe file inside the installer had not been tampered with.
